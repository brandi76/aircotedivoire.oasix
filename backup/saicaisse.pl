...
$bordereau_force=&get("select max(no) from bordereau where date_remise!='0000-00-00'")+1;
...
;
$pass=0;
$query="select * from bordereau where date_remise='0000-00-00' and date_creation>'2011-12-31' order by no";
$sth=$dbh->prepare($query);
$sth->execute();
