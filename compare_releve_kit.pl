...
print "<form>";
&form_hidden();
print "Premiere AAAA-MM-JJ<input type=texte name=premiere value='2014-01-01'><br>";
print "Derniere AAAA-MM-JJ<input type=texte name=derniere value='2014-12-31'><br>";
print "<input type=submit>";
print "</form>";
$premiere=$html->param("premiere");
$derniere=$html->param("derniere");
if (($premiere ne "")&&($derniere ne ""))
{
...
$resultat=$total_gen;
$total_gen=0;
print "<table cellspacing=0 border=1 id=1 class=off>";
...
print "<table cellspacing=0 border=1 id=2 class=off>";
...
$resultat+=$total_gen;
print "<table cellspacing=0 border=1 id=3 class=off>";
...
print "<table border=1 cellspacing=0 cellpadding=0 id=4 class=off><tr><th>Date</th><th>Dev</th><th>Credit</th><th>Reference</th><th>Libelle</th><th><span style=color:red>Devise</span></th></tr>";
