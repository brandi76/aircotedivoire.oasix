...
$query="select pr_cd_pr,pr_desi,pr_prac/100,pr_four from produit where pr_prac>0 and pr_prac<30000000 and pr_cd_pr not in (select code from mag where mag='LeMag27') order by pr_cd_pr";
